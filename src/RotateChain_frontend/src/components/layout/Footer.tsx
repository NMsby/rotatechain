...
export function Footer() {
  ...
  const socialLinks = [
    { name: 'Twitter', href: 'https://twitter.com/rotatechain', icon: Twitter },
    { name: 'GitHub', href: 'https://github.com/rotatechain', icon: Github },
    { name: 'Discord', href: 'https://discord.gg/rotatechain', icon: MessageCircle },
  ]
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-4 max-w-sm">
              ...
              Build wealth together with liquid contribution tokens and cross-group lending.
            </p>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © {currentYear} RotateChain. All rights reserved.
          </p>
